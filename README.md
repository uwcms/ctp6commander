...
You may find it at https://gitlab.cern.ch/WisconsinCMS/CTP7-SW/ctp6commander
...
git remote set-url origin ssh://git@gitlab.cern.ch:7999/WisconsinCMS/CTP7-SW/ctp6commander.git
```
...
```sh
git remote set-url origin https://gitlab.cern.ch/WisconsinCMS/CTP7-SW/ctp6commander.git
```
